...
+ (NSString *)getLastUpdateTimeWithRefreshViewID:(NSInteger)ID
{
    ...
    NSString *time = [[refreshDic objectForKey:JHRefreshLastUpdateTimeKey] objectForKey:[NSString stringWithFormat:@"%@_%ld",JHRefreshLastUpdateTimeKey,ID]];
...
+ (void)updateLastUpdateTimeWithRefreshViewID:(NSInteger)ID
{
    ...
    [lastUpdateTimeDic setObject:[[self class] nowTimeString] forKey:[NSString stringWithFormat:@"%@_%ld",JHRefreshLastUpdateTimeKey,ID]];
