...
NSString *const JHRefreshHeaderStatusTextPulling = @"松开即可完成刷新(●—●)";
NSString *const JHRefreshHeaderStatusTextRefreshing = @"正在刷新……";
NSString *const JHRefreshHeaderStatusTextSuccess = @"刷新成功,喜欢就收藏一下吧(●—●)";
NSString *const JHRefreshHeaderStatusTextFailure = @"刷新失败";

NSString *const JHRefreshFooterStatusTextNormal = @"上拉加载更多";
NSString *const JHRefreshFooterStatusTextPulling = @"松开即可完成加载,欢迎收藏(●—●)";
NSString *const JHRefreshFooterStatusTextRefreshing = @"正在加载……";
NSString *const JHRefreshFooterStatusTextSuccess = @"加载成功,喜欢就收藏一下吧(●—●)";
